...
var crimes = L.geoJson.ajax('../data/json/clean_crime.geojson', {
   ...
   style: function(feature) {
         if (feature.properties.crime_class == 'disorderly_conduct'){
          return {color: '#C18BDA'};
    ...
    // does this feature have a property named popupContent?
     ...
     filter: function(feature){
      if (feature.properties.crime_class == "DUI") return true
      if (feature.properties.crime_class == "drug_sale") return true
      ...
      if (feature.properties.crime_class == "domestic") return true
